...
#define BB_LOGSUC(TAG, format, ...) SerialService::LOG_ln(BB_LL_SUCCESS, TAG, format, ##__VA_ARGS__)
...
#define BB_LOGSPEC(TAG, format, ...) SerialService::LOG_ln(BB_LL_SPECIAL, TAG, format, ##__VA_ARGS__)
...
class SerialService
{
    ...
    private:
        ...
        inline static const constexpr char* GREEN = "\033[32m";            // green (success) BB_LOGSUC
